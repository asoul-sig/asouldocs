# Welcome to _**ASoulDocs**_ contributing guide
...
- For questions, ask in [Discussions](https://github.com/asoul-sig/asouldocs/discussions).
- [Check to make sure](https://docs.github.com/en/github/searching-for-information-on-github/searching-on-github/searching-issues-and-pull-requests#search-by-the-title-body-or-comments) someone hasn't already opened a similar [issue](https://github.com/asoul-sig/asouldocs/issues).
- If a similar issue doesn't exist, open a new issue using a relevant [issue form](https://github.com/asoul-sig/asouldocs/issues/new/choose).

### Pick up an issue to solve

- Scan through our [existing issues](https://github.com/asoul-sig/asouldocs/issues) to find one that interests you.
- The [👋 good first issue](https://github.com/asoul-sig/asouldocs/issues?q=is%3Aissue+is%3Aopen+label%3A%22%F0%9F%91%8B+good+first+issue%22) is a good place to start exploring issues that are well-groomed for newcomers.
